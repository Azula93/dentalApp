...
<head>
    ...
    <style>
        ...
        /** Footer fijo (si quieres más control que con canvas) **/
        footer {
            position: fixed;
            bottom: -60px;
            left: 0;
...
<body>
    <header>
        ...
        <img
            src="{{ public_path('storage/logos/'.$configuracion->logo) }}"
            class="logo"
            alt="Logo Empresa">
        @endif
        <p class="empresa-nombre">{{ $configuracion->nombre_empresa }}</p>
